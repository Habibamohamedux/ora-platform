  ...
  return (
    <section className="transparency-section">
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
      >
        <h1 className="transparency-super-title">The ORA Architecture</h1>
        <p className="transparency-super-subtitle">Engineered for complete data sovereignty and seamless control.</p>
      </motion.div>
      ...
      <div className="transparency-container">
        ...
        <div className="transparency-row">
          ...
          >
            <div className="transparency-glass-card transparency-card-isometric">
              <div className="transparency-credential-leak">
                ...
                <div className="transparency-status-tag">SECURE VAULT</div>
                <div className="transparency-password-pill">
                  <span className="transparency-lock-icon">🛡️</span> Data Encrypted
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <h2 className="transparency-headline">You Are Always in Control</h2>
        ...
        <div className="transparency-row transparency-reverse-mobile">
          ...
          >
            ...
            <h2 className="transparency-headline">Only Validated Access</h2>
            <p className="transparency-description">
          ...
          >
            <div className="transparency-stacked-cards">
              <div className="transparency-stacked-card transparency-card-back">
                <span className="transparency-mute-text">Blocked Request</span>
              </div>
              <div className="transparency-stacked-card transparency-card-middle">
                <span className="transparency-mute-text">Unauthorized Scope</span>
              </div>
              <div className="transparency-stacked-card transparency-card-front transparency-glass-card">
                <div className="transparency-alert-header">
                  ...
                  <span className="transparency-alert-title">Access Granted</span>
                </div>
                <p className="transparency-alert-sub">Verified permissions established.</p>
                <div className="transparency-alert-footer">
                  <span className="transparency-user-id">Session_8x***</span>
                  <span className="transparency-alert-tag safe">Secure Connection</span>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="transparency-row">
          ...
          >
             <div className="transparency-glass-card transparency-dashboard-card">
                <h3 className="transparency-dashboard-title">Privacy Overview</h3>
                <div className="transparency-dashboard-stats">
                  <span className="transparency-threat-actor">Active Scope <span className="transparency-highlight">Read-Only</span></span>
                  <span className="transparency-attempt-count">12 permissions granted</span>
                </div>
                <div className="transparency-dashboard-chart-area">
                   ...
                   <div className="transparency-chart-legend">
                      <div className="transparency-legend-item"><span className="transparency-dot transparency-dot-ghost"></span> Anonymous Data</div>
                      <div className="transparency-legend-item"><span className="transparency-dot transparency-dot-white"></span> System Metrics</div>
                      <div className="transparency-legend-item"><span className="transparency-dot transparency-dot-pink"></span> Personal Identifiers</div>
                   </div>
                </div>
             </div>
          </motion.div>
          ...
          >
            ...
            <h2 className="transparency-headline">Tailored Analytics</h2>
            <p className="transparency-description">
          ...
          <div className="transparency-cta-card">
            ...
            <div className="transparency-cta-content">
              <h2 className="transparency-cta-headline">
                ...
                <span className="transparency-cta-highlight">your first ORA instance.</span>
              </h2>
              <p className="transparency-cta-subtext">
                No setup friction. No integration delays.<br/>
                Go from zero to complete data transparency in minutes, with a seamless onboarding experience.
              </p>
